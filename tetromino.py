...
class Tetromino:
    ...
    def __init__(self, type, grid_height, grid_width, is_next=False):
        ...
        # set the shape of the tetromino based on the given shape
        self.occupied_tiles = []
        if type == 'I':
    ...
    def get_cell_position(self, dx, dy):
            ...
            for row in range(n):
                for col in range(n):
                    ...
                    if dir == "left" and self.tile_matrix[row][col] != None:
                        ...
                        # any of its leftmost tiles is occupied
    ...
    # Method rotates tetrominos clockwise
    ...
    # Method to make hard drop
    def hard_drop(self, game_grid, current_tetromino):
        while current_tetromino.move("down", game_grid):
            pass  # keep moving the tetromino down until it can't move further
